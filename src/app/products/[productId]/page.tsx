...
export default function ProductDetailPage() {
  ...
  const handleAddToCart = () => {
    if (!product) return;
    console.log(`Adding ${product.name} to cart (simulated).`);
    toast({
    ...
    <div className="max-w-5xl mx-auto">
      <Card className="shadow-xl overflow-hidden">
        <div className="grid md:grid-cols-2 gap-0">
          <div className="relative min-h-[300px] md:min-h-[400px] bg-muted/50 flex items-center justify-center p-4 md:p-8">
            <Image
