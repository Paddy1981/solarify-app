...
import { StoreIcon, PackagePlus, ListOrdered, Settings, BarChartHorizontalBig, Factory } from "lucide-react";
...
const mockSupplier = {
  ...
  avatarUrl: "https://placehold.co/120x120.png", // This specific URL is not replaced
      ...
      <Card className="shadow-xl overflow-hidden">
        ...
        <CardContent className="relative pt-0 -mt-12">
          <div className="flex flex-col sm:flex-row items-center sm:items-end space-x-0 sm:space-x-4">
            {mockSupplier.avatarUrl && mockSupplier.avatarUrl.startsWith('https://placehold.co') ? (
                <div 
